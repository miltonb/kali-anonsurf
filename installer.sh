...
echo "deb https://deb.i2p2.de/ jessie main"  > /etc/apt/sources.list.d/i2p.list # HTTPS SUPPORT
echo "deb-src https://deb.i2p2.de/ jessie main" > /etc/apt/sources.list.d/i2p.list # HTTPS SUPPORT
